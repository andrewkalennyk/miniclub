            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="btn btn-primary" >{{__t('Відправити')}}</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <ol>
                        <li>Учасники повинні випадковим чином вибрати імена, щоб визначити, для кого вони будуть купувати подарунок.</li>
                        <li>Встановіть бюджет для подарунків, щоб забезпечити справедливість серед учасників.</li>
                        <li>Тримайте вашу визначену особу в секреті! Мета - їх вражати.</li>
                        <li>Учасники можуть подати бажаний список, щоб дати їхньому Таємному Санті ідеї для подарунка.</li>
                        <li>Подарунки повинні бути завернуті та анонімні, розкриваючи дарувальника лише під час обміну.</li>
                        <li>Встановіть дату обміну подарунками та переконайтеся, що всі можуть взяти участь.</li>
                        <li>Сприяйте творчості та обдуманості вибору подарунків.</li>
                        <li>Не забувайте насолоджуватися тарабарським духом свят!</li>
                    </ol>
