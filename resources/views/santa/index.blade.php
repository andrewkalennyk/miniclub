        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <h2>{{__t('Для тих хто хоче вскочити в останній вагон!')}}</h2>
                    <ol>
                        <li>{!! __t("Кінцева дата подачі заявок - <b>25 грудня 2024 року</b>. Кожен учасник повинен надіслати свою заявку.") !!}</li>
                        <li>{!! __t("<b>26 грудня 2024 року</b> кожен учасник отримає на свою електронну пошту інформацію про особу, щасливчика, і для якої вони повинні подарувати подарунок.") !!}</li>
                        <li>{!! __t("Бюджет на подарунок в межах <b>500-1500 гривень</b>. Учасники повинні дотримуватися цього бюджету.") !!}</li>
                        <li>{!! __t("Дата розіграшу - <b>11 січня 2025 року</b>. Організатори зберуть всі подарунки у багажник тачки і кожен по черзі буде знаходити свій подарунок / Організатори в певний час видадуть подарунок учаснику.") !!}</li>
