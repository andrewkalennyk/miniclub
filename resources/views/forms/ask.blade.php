        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        {{__t(' Ми завжди прагнемо зробити наш клуб кращим місцем для всіх нас, любителів Міні Куперів.')}}
                       {{__t(' Ваша думка є надзвичайно важливою для нас, адже саме завдяки вам наш клуб процвітає та розвивається.')}}
                    </p>
                    <p>
                        {{__t('Ми закликаємо вас висловити свої побажання, ідеї, а також поділитися будь-яким невдоволенням щодо роботи
                        адміністрації клубу. Чи є щось, що ми можемо зробити краще? Можливо, є нові заходи чи події, які ви хотіли б
                        бачити в нашому клубі? Ваші відгуки допоможуть нам вдосконалити нашу роботу та зробити клуб більш затишним
                        та дружнім для кожного з вас.')}}
                    </p>
                    <p>
                        {{__t('Будь ласка, не соромтеся висловлювати свої думки. Ми цінуємо кожен відгук і гарантуємо, що кожен голос буде
                        почутий.')}}
                    </p>
                    <p class="text-center">
